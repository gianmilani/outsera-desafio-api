...
public class ProducersAwardsMapperServiceImpl implements ProducersAwardsMapperService {
    ...
    @Override
    public ResponseProducersAwards mapToResponseProducersAwards(List<ProducerAwardIntervalDomain> producersResults) {
    ...
    private Map<String, List<ProducerAwardIntervalDomain>> groupByProducer(List<ProducerAwardIntervalDomain> producers) {
    ...
    private ResponseProducersAwards buildResponse(Map<Boolean, List<ProducerAwardIntervalDomain>> partitionedProducers) {
